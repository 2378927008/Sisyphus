...
test("Windows UI v4 uses the approved Simplified Chinese shell copy", () => {
  const expected = {
    ...
    "editor.saveRetry": "保存失败，文本已保留。继续编辑即可重试",
    "editor.reprocessing": "正在重新处理",
    "editor.reprocessFailed": "重新处理失败，当前文本已保留",
    "history.recoveryAvailable": "处理失败。你可以编辑原始转写，或重新处理。",
    "history.recoveryUnavailable": "处理失败，且没有可重新处理的原始转写。",
    "tab.dictation": "语音输入",
    "tab.history": "历史",
    "aria.mainTabs": "主视图",
